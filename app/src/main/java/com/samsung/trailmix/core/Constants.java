...
package com.samsung.trailmix.core;
...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.samsung.trailmix";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "TrailMix";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.samsung.trailmix.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.samsung.trailmix.";
